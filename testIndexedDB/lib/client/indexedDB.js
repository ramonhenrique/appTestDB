indexedDBModule = (function () {
    ...
    var createItem = function (id, data, store, update, callback) {
        try {
                    ...
                    try {
                        ...
                        request.onsuccess = function (event) {
                            ...
                            if (update && update == true)
                                ...
                                console.log('A new record with ID = ' + id + ' has been added to the database ');
                                callback();
                            };
                        };
            ...
            dbOpenRequest.onsuccess = function (event) {
                ...
                try {
                    ...
                    try {
                        ...
                        function putNext() {
                            if (i < length) {
                                objectStore.add(JSON.parse(obj)).onsuccess = putNext;
                        ...
                        try {
                            ...
                            requestCount.onsuccess = function (event) {
                                if (requestCount.result) {
                                    console.log('There are ' + requestCount.result + ' entries in the database.');
                                }
                                else {
    ...
    function initDB(db, store) {
        try {
            ...
            dbOpenRequest.onupgradeneeded = function (e) {
                ...
                var transaction = dbOpenRequest.transaction;
                try {
                    var storeOptions = { autoIncrement: true }; //possible pass storeOptions in init and further to initDB
